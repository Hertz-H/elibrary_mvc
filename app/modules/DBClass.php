...
class DatabaseClass{
    ...
    private $pdo;
    function __construct($dsn="mysql:host=localhost;dbname=e-commerce;charset=utf8mb4",$username="root",$password=" ")
    {
   ...
   public function select($table,$sl_list=null,$where=null){
        if($sl_list!=null){
